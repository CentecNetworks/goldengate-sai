...
struct ctc_internal_port_assign_para_s
{
    ...
    uint16 inter_port;      /**< the internal port which is assigned or setted, range 64-XX */
    uint32 fwd_gport;       /**< this is the dest port of FWD type */
    uint32 nhid;            /**< Nexthop information for CTC_INTERNAL_PORT_TYPE_ELOOP */
};
