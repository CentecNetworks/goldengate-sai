...
typedef enum _sai_next_hop_type_t
{
    ...
    /**Port type nexthop, used for IPMC*/
    SAI_NEXT_HOP_PORT,
...
typedef enum _sai_next_hop_attr_t
{
    ...
    /** Next hop entry port, used for IPMC, Assosiated Port or Lag object id, [sai_object_id_t]*/
    /*when SAI_NEXT_HOP_ATTR_TYPE == SAI_NEXT_HOP_PORT*/
    /*CREATE_ONLY)*/
    SAI_NEXT_HOP_ATTR_PORT,

    /** Next hop entry vlan, used for IPMC, [sai_vlan_id_t]*/
    /*when SAI_NEXT_HOP_ATTR_TYPE == SAI_NEXT_HOP_PORT*/
    /*CREATE_ONLY)*/
    SAI_NEXT_HOP_ATTR_VLAN,
